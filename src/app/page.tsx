      ...
      <section className="sec container">
        ...
        <div className="grid-c">
          <article className="ccard">
            ...
            <div className="ccard-b"><h3>Bahasa Arab untuk Pemula — Dasar Nahwu</h3><p className="by">Ust. Abdullah, Lc.</p><div className="cmeta"><span><svg className="ico ico-sm"><use href="#i-star" /></svg>4.9</span><span><svg className="ico ico-sm"><use href="#i-book" /></svg>32 materi</span><span>Pemula</span></div><div className="cfoot"><span className="price">Rp 149.000</span><a href="/kelas" className="btn btn-soft btn-sm">Lihat</a></div></div>
          </article>
          <article className="ccard">
            ...
            <div className="ccard-b"><h3>Tahsin Al-Qur&apos;an Metode Tilawati</h3><p className="by">Ustadzah Fatimah</p><div className="cmeta"><span><svg className="ico ico-sm"><use href="#i-star" /></svg>5.0</span><span><svg className="ico ico-sm"><use href="#i-clock" /></svg>Tiap Sabtu</span></div><div className="cfoot"><span className="price">Rp 250.000</span><a href="/kelas" className="btn btn-soft btn-sm">Lihat</a></div></div>
          </article>
          <article className="ccard">
